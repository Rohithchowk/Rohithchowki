...
export const ResumeButton = styled.a`
    ...
    background: #03e9f4;
    background: linear-gradient(225deg, #03e9f4 0%, #d4af37 100%);
    background: -moz-linear-gradient(225deg, #03e9f4 0%,  #d4af37 100%);
    background: -webkit-linear-gradient(225deg,  #03e9f4 0%, hsla(294, 100%, 50%, 1) 100%);
    box-shadow:  20px 20px 60px #1F2634,
