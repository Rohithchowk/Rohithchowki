export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/11wr6R_g6sIzqbErarm_qo7XZqd89xiVa/view?usp=sharing",
  ...
  email:"mailto:rohith28chowki@gmail.com"
  ...
  },
  {
    ...
    skills: [
     ...
     
      {
        name: "MySQL",
        image:
          "https://i.imgur.com/CMUeDlT.png",
      },
     
      {
        name: "MongoDB",
        image:
          "https://i.imgur.com/8esCfAn.png",
      },
      {
        name: "Firebase",
    ...
    skills: [
      {
        name: "Aws(Basic Lvl.)",
        image:
          " https://i.imgur.com/GGeWt8K.png"
        },
      {
        name: "Jenkins",
        image:
          "https://i.imgur.com/HSDt6Os.png",
      },
      {
        name: "Docker",
        image:
          "https://i.imgur.com/Xq0KtZV.png",
      },
      
    ],
  },
  {
    title: "Programming Languages & Relevant Coursework",
    skills: [
      {
        name: "Java",
        image:
          " https://i.imgur.com/82dKel6.png"
        },
      {
        name: "Python",
        image:
          "https://i.imgur.com/I1gGTdY.jpg",
      },
      {
        name: "C",
        image:
          "https://i.imgur.com/akbyuVx.png",
      },
      {
        name: "Data structures & Algorithms ",
        image:
          "https://i.imgur.com/P5Wg10t.png"
        },
    ...
    skills: [
      {
        ...
        image:
          "https://i.imgur.com/kE1w1lA.jpg",
      },
      {
        name: "React Native",
        image:
          "https://i.imgur.com/RTP5kK8.png",
      },
...
export const experiences = [
  {
    ...
    desc: "– Expertly crafted and learnt about AWS EC2,ELB,S3,ASG and deployed many web and ML models. Attained expertise in effectively utilizing S3 Services , AWS Ec2,ASG .",
    skills: [
      "AWS",
      "EC2",
      "S3 Buckets"
...
export const education = [
  {
    ...
    date: " 2021 - 2025",
    grade: "9.17 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Information Technology  at , Chaitanya Bharathi Institute of Technology , Gandipet, Hyderabad. I have completed 4 semesters and have a CGPA of 9.17. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, Full stack web development among others. ",
    degree: "Bachelor of Engineering - B.E, Information Technology",
  },
  {
    id: 1,
    img: "https://i.imgur.com/iOdQ7UT.png",
    College: "Narayana Junior College",
    date: " 2019 -  2021",
    grade: "98.6%",
    desc: "I completed my Intermediate at Narayana Junior College, Hyderabad, where I studied MPC.",
    degree: "Intermediate -MPC",
  },
  {
    id: 2,
    img: "https://i.imgur.com/SsqHuTT.jpg",
    school: "Vignan High School , Sircilla",
    date: "2018 - 2019",
    grade: "9.8 GPA",
    desc: "I completed my class 10 education at Vignan High School , Sircilla.",
    degree: "X class",
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Presenting the CBIT IT Department Website, a dynamic MERN stack creation. This platform features an interactive chatbot for college queries, a captivating 360-degree campus view, and detailed sections on departments, notable alumni, facilities, achievements, and faculty.  This project showcases my proficiency in MongoDB, Express.js, React.js, and Node.js, demonstrating a fusion of technical expertise and creative design for an engaging digital presence.NOTE : I DIDNT MADE IT RESPONSIVE , VIEW THE WEBSITE IN LAPTOP FOR PROPER PAGE RENDERING .",
    image:
      "https://i.imgur.com/ETkXMbu.jpg",
    tags: [
    ...
    category: "web app",
    github: "https://github.com/Rohithchowk/fsdproject",
    webapp: "https://fsdproject.vercel.app",
  },
  {
    id: 0,
    title: "Dynamic ALumni page ",
  
    description:
      "Developed a full-stack web application that allows users to create an  alumni page for his college . In this the user is dispalyed with a form page where there are many input fields given to him and asks him to enter his college details like placement highlights , alumni info , Affiliations and Accreditations , awards to the college and other lot of details . After clicking the submit button these contents are dynamically rendered into their specific positions , with  a navbar setup and routing between pages .",
    image:
      "https://i.imgur.com/zHtliGk.png",
    tags: ["React Js", "MongoDb", "Node Js", "Express Js", "Vite","MUI"],
    category: "web app",
    github: "https://github.com/Rohithchowk/Dynamic-alumni.git",
    webapp: "",
 ...
 
  {
    ...
    date: "",
    description:
      "A real time chatting  app  made with MERN technology and Material UI.  It has a chat room where users can chat with each other. It has a sidebar where users can see all the chat rooms and can create a new chat room. It has a login page and signup page , where users can sign up and login.",
    image:
      "https://i.imgur.com/JGRPViF.png",
    tags: [
      "React Js",
      "MongoDb",
      "Node Js",
    ...
    category: "web app",
    github: "https://github.com/Rohithchowk/Real_time_chat_app.git",
    webapp: "",
  },
  {
    id: 2,
    ...
    description:
      "Preprocessed the dataset to improve model accuracy and  trained the model . Achievements: Achieved an accuracy of 95.2% to accurately detect License plate numbers from Vehicle  images.",
    image:
      "https://i.imgur.com/XcLmVih.jpg",
    tags: ["Python", "OCR", "TensorFlow", "Opencv", "CNN"],
  ...
  {
    id: 5,
    title: "CRUD app in MERN STACK.",
    date: "Jun 2021",
    description:
      "This is my first project of MERN . It is a CRUD application developed using React.js , Node.js , Express.js, MongoDB and MUI . In this project , the user can add a person with details like name , email , mobile ,addr. , can edit edit the details of person and delete the person details .",
    image:
      "https://i.imgur.com/9yUCy0e.png",
    tags: ["React Js", "MOngoDB", "Express.js", "Node JS","MUI"],
    category: "web app",
  ...
  
  {
    ...
    description:
      "A basic android Todolist app made with React-native. You can create tasks that you want to do and schedule them accordingly.  ",
    image:
      "ht",
    tags: ["React-Native",],
    category: "android app",
    github: "https://github.com/Rohithchowk/todolist_android_app.git",
    webapp: "https://github.com/Rohithchowk/todolist_android_app.git",
  },
  {
    id: 8,
    title: "CHATBOT",
    ...
    description:
      "Our chatbot gives information about CBIT college placements , packages , clubs , events , faculty etc .and also about IT dept .",
    image:
      "https://i.imgur.com/EfmoCEc.png",
    tags: ["Python", "NeuralNet", "Pytorch", "Javascript", "Html","Flask" ],
    category: "machine learning",
    github: "https://github.com/Rohithchowk/CBITchatbot.git",
    webapp: "https://chandra76768.pythonanywhere.com",
  },
  {
    id:11 ,
    ...
    description:
      "This is a basic ML project , which predicts the sale price of the houses.",
    image:
      "https://i.imgur.com/g7o5xQl.png",
    tags: ["Python", "RandomForestregressor", "JupyterNotebook" ],
    category: "machine learning",
    github: "https://github.com/Rohithchowk/housepriceprediction.git",
